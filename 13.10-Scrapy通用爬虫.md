...
这里我们以中华网科技类新闻为例来了解一下 CrawlSpider 和 Item Loader 的用法，然后再提取其可配置信息实现可配置化，官网链接为：[http://tech.china.com/](http://tech.china.com/)，我们需要爬取它的科技类新闻内容，链接为：[http://tech.china.com/articles/](http://tech.china.com/articles/)，页面如图所示：
