...
接下来再敲击 esc 和 q 键返回，这时我们就可以看到最上面的请求链接就变成了：[https://www.baidu.com/s?wd=NBA](https://www.baidu.com/s?wd=NBA)，这个页面访问之后可以看到百度搜索 NBA 关键词的搜索结果，如图 11-22 所示：
