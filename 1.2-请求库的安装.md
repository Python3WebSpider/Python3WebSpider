...
另外，如果你的系统是 Mac OS X El Capitan 10.11 及更新版本的话，需要先关闭 Rootless 内核保护机制，具体可参考：[http://www.pc6.com/edu/86809.html](http://www.pc6.com/edu/86809.html)。
...
PhantomJS 是一个无界面的、可脚本编程的WebKit浏览器引擎，它原生支持多种 Web 标准：DOM 操作、CSS 选择器、JSON、Canvas 以及 SVG。
